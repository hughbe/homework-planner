...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UIColor *barTintColor = [[UIColor colorWithRed:(CGFloat) (103.0 / 255.0) green:(CGFloat) (130.0 / 255.0) blue:(CGFloat) (180.0 / 255.0) alpha:1.0] add_darkerColorWithValue:0.75];
